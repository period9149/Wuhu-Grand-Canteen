  ...
  <v-app id="inspire">
    <v-navigation-drawer v-model="drawer" app clipped>
      <v-list dense>
        ...
        <v-list-item class="mt-4" v-if="$store.state.auth.user">
          <v-list-item-action>
            <v-icon color="grey darken-1">mdi-rice</v-icon>
          </v-list-item-action>
          <v-list-item-title class="grey--text text--darken-1"
            >开饭啦，{{ $store.state.auth.user.username }}！</v-list-item-title
          >
        </v-list-item>
        ...
        <v-list-item link v-if="$store.state.auth.user">
          <v-list-item-action>
    ...
    <v-app-bar app clipped-left color="red" dense>
      ...
      <v-toolbar-title class="mr-12 align-center">
        <span class="title" style="color: white">肉蛋葱鸡</span>
      </v-toolbar-title>
      <v-spacer />
